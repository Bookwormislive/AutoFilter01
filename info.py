...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6011680723 1524169222').split()]
USERNAME = environ.get('USERNAME', "https://t.me/the_universal_being")
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002199534111'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/InfoHub_Hall')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002143530897').split()]
DATABASE_URI = environ.get('DATABASE_URI', "mongodb")

#Auto approve 
CHAT_ID = [int(app_chat_id) if id_pattern.search(app_chat_id) else app_chat_id for app_chat_id in environ.get('CHAT_ID', '').split()]
TEXT = environ.get("APPROVED_WELCOME_TEXT", "<b>{mention},\n\nʏᴏᴜʀ ʀᴇǫᴜᴇsᴛ ᴛᴏ ᴊᴏɪɴ {title} ɪs ᴀᴘᴘʀᴏᴠᴇᴅ.\n\‣ DEVELOPED BY @the_universal_being</b>")
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002199534111'))
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002199534111'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002199534111'))
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002194859003'))
...
REF_PREMIUM = 30
PREMIUM_POINT = 1500
auth_channel = environ.get('AUTH_CHANNEL', '-1002170049626')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-4210070564'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002143530897')
REQUEST_CHANNEL = int(request_channel) if request_channel and id_pattern.search(request_channel) else None
UPI_PAY_LOGS = int(environ.get('UPI_PAY_LOGS', '-1002194859003'))
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002143530897'))
